...
const InventoryItemModel = require('../../reference-book_models/term-types_models/inventory-item');
...
const responseExecutors = new responseExecutorsClass(InventoryItemModel, false);
