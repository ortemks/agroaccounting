...
const MeasurementModel = require('../../reference-book_models/term-types_models/measurement');


const authentication = require('../../../authentication');

const RequestParsersClass = require('../../reference-book_middlewares/routes_middlewares/request-parsers');
const requestParsers = new RequestParsersClass(MeasurementModel, false);
...
const responseExecutors = new responseExecutorsClass(MeasurementModel, false);
