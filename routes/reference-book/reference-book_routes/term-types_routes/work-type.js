...
const URL = '/work-types'

const WorkTypeModel = require('../../reference-book_models/term-types_models/work-type');
...
const responseExecutors = new responseExecutorsClass(WorkTypeModel, false);
