...
const URL = '/field-numbers'

const FieldNumberModel = require('../../reference-book_models/term-types_models/field-number');


const authentication = require('../../../authentication');

const RequestParsersClass = require('../../reference-book_middlewares/routes_middlewares/request-parsers');
const requestParsers = new RequestParsersClass(true);
...
const responseExecutors = new responseExecutorsClass(FieldNumberModel, true);
