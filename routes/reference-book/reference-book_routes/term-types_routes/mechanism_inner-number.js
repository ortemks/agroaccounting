...
const URL = '/mechanism-inner-numbers'

const MechanismInnerNumberModel = require('../../reference-book_models/term-types_models/mechanism_inner-number');
...
const responseExecutors = new responseExecutorsClass(MechanismInnerNumberModel, true);
