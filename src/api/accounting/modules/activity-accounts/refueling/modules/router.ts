import Refueling from "./interface";
...
export default function setRouter(this: Refueling, router: Router) {
    router.route('/refuelings')
    ...
    router.route('/refuelings/confirmation')
